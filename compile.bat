...
if exist %QT_DIR%\bin\libwinpthread-1.dll xcopy %QT_DIR%\bin\libwinpthread-1.dll  %DESTINATION%\ /C /H /R /Y /Q
if exist %QT_DIR%\bin\mingwm10.dll xcopy %QT_DIR%\bin\mingwm10.dll         %DESTINATION%\ /C /H /R /Y /Q
