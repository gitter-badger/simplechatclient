...
echo Download Qt 5.3.0 for MinGW from http://qt-project.org/downloads
pause
exit
)
...
if not exist %QT_DIR%\include\QtCrypto\qca.h (
...
xcopy %QT_DIR%\plugins\audio\qtaudio_windows.dll     %DESTINATION%\plugins\audio\ /C /H /R /Y /Q
