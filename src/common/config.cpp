...
QString Config::get_value(QString strKey)
{
    ...
    strlValues << "~test" << "" << "pl" << "off" << "off" << "off" << "off" << "on" << "on" << "off" << "off" << "modern" << "#ffffff" << "off" << "off" << "Verdana" << "#000000" << "11px" << "#000000" << "#009300" << "#4733FF" << "#00007F" << "#00007F" << "#009300" << "#0066FF" << "#666666" << "#ff0000" << "#0000ff" << "#333333" << "#ffffff" << "#a0a0a4" << "#77d5f7" << "#1b86b7" << "off" << strSoundBeep << strSoundQuery << "off";
