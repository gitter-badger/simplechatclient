...
dlg_friends_ad::dlg_friends_ad(QTcpSocket *param1, tab_container *param2, QSettings *param3, QString param4)
{
    ui.setupUi(this);
...
void dlg_friends_ad::button_ok()
{
    ...
    {
        if (strStatus == "add")
            dlg_friends_ad::send(QString("NS FRIENDS ADD %1").arg(strNick));
        else
...
void dlg_friends_ad::send(QString strData)
{
