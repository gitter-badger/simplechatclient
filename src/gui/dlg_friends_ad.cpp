...
DlgFriendsAd::DlgFriendsAd(QWidget *parent, Network *param1, QSettings *param2, QString param3, QString param4) : QDialog(parent)
{
    ui.setupUi(this);
    ...
    settings = param2;
    strStatus = param3;
    ui.lineEdit_friend->setText(param4);
